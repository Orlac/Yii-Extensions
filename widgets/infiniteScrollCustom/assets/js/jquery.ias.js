...
(function ($) {
    ...
    $.ias = function (options)
    {
        ...
        function scroll_handler()
        {
            var curScrOffset,
                scrTreshold;
            //todo if container !visible \ return
        ...
        $.ias.scroll_handler=scroll_handler;
        ...
        {
            var urlNextPage;
            var visible = $(opts.container).is(':visible');
            if(!visible){
                return;
            }
            ...
            loadItems(urlNextPage, function (data, items) {
                ...
                //opts.next='#Salon .next a';
//                console.log('0', opts.next);
//                console.log('1', data);
//                console.log('2', $(data));
//                console.log('3', $(opts.next, $(data) ));
        ...
        function loadItems(url, onCompleteHandler, delay)
        {
            ...
            $.get(url, null, function (data) {
                ...
                container = $(opts.currentItemsSelector, data.html).eq(0);
                ...
                if (onCompleteHandler) {
                    ...
                    if (diffTime < delay) {
                        setTimeout(function () {
                            onCompleteHandler.call(self, data.html, items);
                        }, delay - diffTime);
                    } else {
                        onCompleteHandler.call(self, data.html, items);
                    }
        ...
        function reini(){
            if($.ias.stoped){
                $.iasOpts.scrollContainer.scroll($.ias.scroll_handler);
                $.ias.stoped=false;
                hide_pagination();
                $.ias.paging.reset();
            }
